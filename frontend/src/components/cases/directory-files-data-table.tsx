...
interface DirectoryFilesDataTableProps {
  documents: Document[];
}

export function DirectoryFilesDataTable({ documents }: DirectoryFilesDataTableProps) {
  ...
  const columns: ColumnDef<Document>[] = [
    ...
    {
      accessorKey: "linked_source.parent_folder",
      header: ({ column }) => {
        return (
          <Button
            variant="ghost"
