...
async def generate_summary(
    ...
    Args:
        course_id: ID du cours (format: "course:xxx" ou "xxx")
    ...
    """
    logger.info(f"Tool: generate_summary called with course_id={course_id}, document_id={document_id}")
...
async def generate_mindmap(
    ...
    """
    logger.info(f"Tool: generate_mindmap called with course_id={course_id}, document_id={document_id}, topic={focus_topic}")
...
async def generate_quiz(
    ...
    """
    logger.info(f"Tool: generate_quiz called with course_id={course_id}, num_questions={num_questions}, difficulty={difficulty}")
...
async def explain_concept(
    ...
    """
    logger.info(f"Tool: explain_concept called with course_id={course_id}, concept='{concept}', level={detail_level}")
